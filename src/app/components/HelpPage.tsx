...
export function HelpPage() {
  return (
    <div style={{ background: '#090514', minHeight: '100dvh', color: '#C4C9E0', fontFamily: 'Manrope, sans-serif', padding: '40px 20px 80px', maxWidth: '680px', margin: '0 auto', lineHeight: 1.7 }}>
      {/* Logo */}
